 ...
 *
 * <p/>
 * NOTE: This function has been automatically generated from the [io.vertx.ext.influxdb.VertxInfluxDbOptions original] using Vert.x codegen.
 */
fun VertxInfluxDbOptions(
  authenticationOptions: io.vertx.ext.influxdb.AuthenticationOptions? = null,
  batchDelay: Int? = null,
  batchSize: Int? = null,
  ...
  port: Int? = null,
  prefix: String? = null,
  schedule: Int? = null): VertxInfluxDbOptions = io.vertx.ext.influxdb.VertxInfluxDbOptions().apply {
