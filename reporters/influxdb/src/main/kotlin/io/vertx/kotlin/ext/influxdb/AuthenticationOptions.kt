 ...
 *
 * <p/>
 * NOTE: This function has been automatically generated from the [io.vertx.ext.influxdb.AuthenticationOptions original] using Vert.x codegen.
 */
fun AuthenticationOptions(
  enabled: Boolean? = null,
  secret: String? = null,
  username: String? = null): AuthenticationOptions = io.vertx.ext.influxdb.AuthenticationOptions().apply {
