...
A `link:../../jsdoc/module-vertx-monitoring-js_metrics_service-MetricsService.html[MetricsService]` can be created out of a `link:../../jsdoc/module-vertx-js_measured-Measured.html[Measured]` object
...
[source,js]
----
var MetricsService = require("vertx-monitoring-js/metrics_service");
