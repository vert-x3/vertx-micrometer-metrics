...
Note also that some names were changed in Vert.x 4 to better
match conventions. You can enable a compatibility mode to stick to Vert.x 3 metrics names, using
{@link io.vertx.micrometer.MicrometerMetricsOptions#setCompatibilityNames}
...
|`vertx_net_client_bytes_received`
|`local`, `remote`
|Counter
|Number of bytes received from the remote host.

|`vertx_net_client_bytes_sent`
|`local`, `remote`
|Counter
...
|`vertx_http_client_bytes_received`
|`local`, `remote`
|Counter
|Number of bytes received from the remote host.

|`vertx_http_client_bytes_sent`
|`local`, `remote`
|Counter
|Number of bytes sent to the remote host.
...
|`vertx_http_client_request_active`
...
|`vertx_http_client_response_time`
|`local`, `remote`, `path`, `method`, `code`
|Timer
|Response time.

|`vertx_http_client_responses`
|`local`, `remote`, `path`, `method`, `code`
|Counter
...
|`vertx_http_client_ws_connections`
|`local`, `remote`
|Gauge
...
|`vertx_net_server_bytes_received`
|`local`, `remote`
|Counter
|Number of bytes received by the Net Server.

|`vertx_net_server_bytes_sent`
|`local`, `remote`
|Counter
...
|`vertx_http_server_bytes_received`
|`local`, `remote`
|Counter
|Number of bytes received by the HTTP Server.

|`vertx_http_server_bytes_sent`
|`local`, `remote`
|Counter
...
|`vertx_http_server_request_active`
|`local`, `remote`, `path`, `method`
|Gauge
...
|`vertx_http_server_request_reset`
|`local`, `remote`, `path`, `method`
|Counter
...
|`vertx_http_server_response_time`
|`local`, `remote`, `path`, `method`, `code`, `route`
|Timer
