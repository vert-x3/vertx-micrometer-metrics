...
|`vertx_net_client_read_bytes`
|`local`, `remote`
|Counter
|Number of bytes received from the remote host.

|`vertx_net_client_written_bytes`
|`local`, `remote`
|Counter
...
|`vertx_http_client_read_bytes`
|`local`, `remote`
|Counter
|Number of bytes received from the remote host.

|`vertx_http_client_written_bytes`
|`local`, `remote`
|Counter
|Number of bytes sent to the remote host.
...
|`vertx_net_server_read_bytes`
|`local`, `remote`
|Counter
|Number of bytes received by the Net Server.

|`vertx_net_server_written_bytes`
|`local`, `remote`
|Counter
...
|`vertx_http_server_read_bytes`
|`local`, `remote`
|Counter
|Number of bytes received by the HTTP Server.

|`vertx_http_server_written_bytes`
|`local`, `remote`
|Counter
...
|`vertx_eventbus_written_bytes`
|`address`
|Summary
|Total number of bytes sent while sending messages to event bus cluster peers.

|`vertx_eventbus_read_bytes`
|`address`
|Summary
