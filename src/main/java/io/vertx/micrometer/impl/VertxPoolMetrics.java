...
class VertxPoolMetrics extends AbstractMetrics {
  ...
  VertxPoolMetrics(MeterRegistry registry, boolean compatMode) {
    ...
    inUse = longGauges(compatMode ? "inUse" : "in.use", "Number of resources used", Label.POOL_TYPE, Label.POOL_NAME);
